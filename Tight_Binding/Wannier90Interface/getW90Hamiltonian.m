function W90Hamiltonian = getW90Hamiltonian(W90Data, kk)
    ...
    W90HamiltonianTmp = zeros(size(kk, 1), ...
                              W90Data(1).numWann, W90Data(1).numWann);
    ...
    for kkii = 1 : size(kk, 1)
        ...
        for nn = 1 : length(W90Data.hamiltonianRaw)
            ...
            W90HamiltonianTmp(kkii, ...
                        W90Data.hamiltonianRaw(nn, 4), ...
                        W90Data.hamiltonianRaw(nn, 5)) = ...
                W90HamiltonianTmp(kkii, ...
                            W90Data.hamiltonianRaw(nn, 4), ...
                            W90Data.hamiltonianRaw(nn, 5)) ...
                + ( ...
                     W90Data.hamiltonianRaw(nn, 6)  ... % IMAGINARY PART IS MISSING !!!
                   * exp(1i * 2*pi ...
                          * kk(kkii, 1:3) ... 
                          * W90Data.hamiltonianRaw(nn, 1:3)') ...
                   * 1 / W90Data.degeneracy(indDegen) ...
                  );

            if(floor(nn/W90Data.numWann^2)-ceil(nn/W90Data.numWann^2) == 0)
                indDegen = indDegen + 1;
            end

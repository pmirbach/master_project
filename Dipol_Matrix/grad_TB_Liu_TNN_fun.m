...
grad_H_kx = a / 2 * 1e3 * [V0_alpha , V1_alpha , V2_alpha ; ...
    V1_alpha' , V11_alpha , V12_alpha ; ...
    V2_alpha' , V12_alpha' , V22_alpha]; 
grad_H_ky = a * 1e3 * sqrt(3) / 2 * [V0_beta , V1_beta , V2_beta ; ...
    V1_beta' , V11_beta , V12_beta ; ...
    V2_beta' , V12_beta' , V22_beta]; 
